...
enforcement_points := {
    ...
    "mount_cims": {"introducedVersion": "0.12.0", "default_results": {"allowed": false}, "use_framework": false},
    "registry_changes": {"introducedVersion": "0.12.0", "default_results": {"allowed": false}, "use_framework": false},
    ...
    "mapped_directory_mount": {"introducedVersion": "0.12.0", "default_results": {"allowed": true}, "use_framework": false},
    "mapped_directory_unmount": {"introducedVersion": "0.12.0", "default_results": {"allowed": true}, "use_framework": false},
    "unmount_cims": {"introducedVersion": "0.12.0", "default_results": {"allowed": true}, "use_framework": false},
    "log_provider": {"introducedVersion": "0.12.0", "default_results": {"allowed": true, "providers_to_keep": null}, "use_framework": false},
