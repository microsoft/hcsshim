...
func file_github_com_Microsoft_hcsshim_internal_extendedtask_extendedtask_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_Microsoft_hcsshim_internal_extendedtask_extendedtask_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_github_com_Microsoft_hcsshim_internal_extendedtask_extendedtask_proto_msgTypes[1].Exporter = func(v any, i int) any {
