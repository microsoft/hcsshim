...
type Options struct {
	...
	// global_container_annotations specifies a set of annotations that should be set for every workload container
	GlobalContainerAnnotations map[string]string `protobuf:"bytes,18,rep,name=global_container_annotations,json=globalContainerAnnotations,proto3" json:"global_container_annotations,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "containerd.runhcs.v1.Options.GlobalContainerAnnotationsEntry")
...
var fileDescriptor_b643df6839c75082 = []byte{
	...
	,
}
...
func (m *Options) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.GlobalContainerAnnotations) > 0 {
		for k := range m.GlobalContainerAnnotations {
			v := m.GlobalContainerAnnotations[k]
			baseI := i
			i -= len(v)
			copy(dAtA[i:], v)
...
func (m *Options) Size() (n int) {
	...
	if len(m.GlobalContainerAnnotations) > 0 {
		for k, v := range m.GlobalContainerAnnotations {
			_ = k
			_ = v
...
func (this *Options) String() string {
	...
	keysForGlobalContainerAnnotations := make([]string, 0, len(this.GlobalContainerAnnotations))
	for k, _ := range this.GlobalContainerAnnotations {
		keysForGlobalContainerAnnotations = append(keysForGlobalContainerAnnotations, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForGlobalContainerAnnotations)
	mapStringForGlobalContainerAnnotations := "map[string]string{"
	for _, k := range keysForGlobalContainerAnnotations {
		mapStringForGlobalContainerAnnotations += fmt.Sprintf("%v: %v,", k, this.GlobalContainerAnnotations[k])
	}
	mapStringForGlobalContainerAnnotations += "}"
	s := strings.Join([]string{`&Options{`,
		...
		`GlobalContainerAnnotations:` + mapStringForGlobalContainerAnnotations + `,`,
...
func (m *Options) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IoRetryTimeoutInSec", wireType)
			}
			m.IoRetryTimeoutInSec = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowRunhcs
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.IoRetryTimeoutInSec |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 18:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GlobalContainerAnnotations", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.GlobalContainerAnnotations == nil {
				m.GlobalContainerAnnotations = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.GlobalContainerAnnotations[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRunhcs(dAtA[iNdEx:])
