...
// Package ncproxy_mock is a generated GoMock package.
package ncproxy_mock

import (
	context "context"
	reflect "reflect"

	nodenetsvc "github.com/Microsoft/hcsshim/cmd/ncproxy/nodenetsvc"
...
func (m *MockNodeNetworkServiceClient) ConfigureContainerNetworking(ctx context.Context, in *nodenetsvc.ConfigureContainerNetworkingRequest, opts ...grpc.CallOption) (*nodenetsvc.ConfigureContainerNetworkingResponse, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(*nodenetsvc.ConfigureContainerNetworkingResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockNodeNetworkServiceClient) ConfigureNetworking(ctx context.Context, in *nodenetsvc.ConfigureNetworkingRequest, opts ...grpc.CallOption) (*nodenetsvc.ConfigureNetworkingResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*nodenetsvc.ConfigureNetworkingResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockNodeNetworkServiceClient) GetHostLocalIpAddress(ctx context.Context, in *nodenetsvc.GetHostLocalIpAddressRequest, opts ...grpc.CallOption) (*nodenetsvc.GetHostLocalIpAddressResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*nodenetsvc.GetHostLocalIpAddressResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockNodeNetworkServiceClient) PingNodeNetworkService(ctx context.Context, in *nodenetsvc.PingNodeNetworkServiceRequest, opts ...grpc.CallOption) (*nodenetsvc.PingNodeNetworkServiceResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*nodenetsvc.PingNodeNetworkServiceResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// ConfigureContainerNetworking mocks base method.
func (m *MockNodeNetworkServiceServer) ConfigureContainerNetworking(arg0 context.Context, arg1 *nodenetsvc.ConfigureContainerNetworkingRequest) (*nodenetsvc.ConfigureContainerNetworkingResponse, error) {
	m.ctrl.T.Helper()
...
// ConfigureNetworking mocks base method.
func (m *MockNodeNetworkServiceServer) ConfigureNetworking(arg0 context.Context, arg1 *nodenetsvc.ConfigureNetworkingRequest) (*nodenetsvc.ConfigureNetworkingResponse, error) {
	m.ctrl.T.Helper()
...
// GetHostLocalIpAddress mocks base method.
func (m *MockNodeNetworkServiceServer) GetHostLocalIpAddress(arg0 context.Context, arg1 *nodenetsvc.GetHostLocalIpAddressRequest) (*nodenetsvc.GetHostLocalIpAddressResponse, error) {
	m.ctrl.T.Helper()
...
// PingNodeNetworkService mocks base method.
func (m *MockNodeNetworkServiceServer) PingNodeNetworkService(arg0 context.Context, arg1 *nodenetsvc.PingNodeNetworkServiceRequest) (*nodenetsvc.PingNodeNetworkServiceResponse, error) {
	m.ctrl.T.Helper()
