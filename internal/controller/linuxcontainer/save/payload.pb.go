...
type Payload struct {
	...
	Processes     map[string]*anypb.Any `protobuf:"bytes,7,rep,name=processes,proto3" json:"processes,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
const file_github_com_Microsoft_hcsshim_internal_controller_linuxcontainer_save_payload_proto_rawDesc = "" +
	...
	"\n" +
	"guest_path\x18\x02 \x01(\tR\tguestPathBKZIgithub.com/Microsoft/hcsshim/internal/controller/linuxcontainer/save;saveb\x06proto3"
...
var file_github_com_Microsoft_hcsshim_internal_controller_linuxcontainer_save_payload_proto_goTypes = []any{
	(*Payload)(nil),             // 0: hcsshim.controller.linuxcontainer.save.v1.Payload
	(*Layers)(nil),              // 1: hcsshim.controller.linuxcontainer.save.v1.Layers
	(*LayerReservation)(nil),    // 2: hcsshim.controller.linuxcontainer.save.v1.LayerReservation
	nil,                         // 3: hcsshim.controller.linuxcontainer.save.v1.Payload.ProcessesEntry
...
var file_github_com_Microsoft_hcsshim_internal_controller_linuxcontainer_save_payload_proto_depIdxs = []int32{
	4, // 0: hcsshim.controller.linuxcontainer.save.v1.Payload.io_retry_timeout:type_name -> google.protobuf.Duration
	1, // 1: hcsshim.controller.linuxcontainer.save.v1.Payload.layers:type_name -> hcsshim.controller.linuxcontainer.save.v1.Layers
	3, // 2: hcsshim.controller.linuxcontainer.save.v1.Payload.processes:type_name -> hcsshim.controller.linuxcontainer.save.v1.Payload.ProcessesEntry
	2, // 3: hcsshim.controller.linuxcontainer.save.v1.Layers.ro_layers:type_name -> hcsshim.controller.linuxcontainer.save.v1.LayerReservation
	2, // 4: hcsshim.controller.linuxcontainer.save.v1.Layers.scratch:type_name -> hcsshim.controller.linuxcontainer.save.v1.LayerReservation
	5, // 5: hcsshim.controller.linuxcontainer.save.v1.Payload.ProcessesEntry.value:type_name -> google.protobuf.Any
