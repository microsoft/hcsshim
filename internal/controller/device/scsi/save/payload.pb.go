...
//
// A payload is only emitted when every disk is in the Attached stage and
// every mount is in the Mounted stage, so per-entry lifecycle stages are not
// carried on the wire.
type Payload struct {
...
// in [Payload.disks]. Every disk in a payload is implicitly in the Attached
// stage.
type DiskState struct {
	...
	Mounts        map[uint64]*MountState `protobuf:"bytes,2,rep,name=mounts,proto3" json:"mounts,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_github_com_Microsoft_hcsshim_internal_controller_device_scsi_save_payload_proto_rawDesc = "" +
	...
	"\tpartition\x18\x02 \x01(\x04R\tpartitionBHZFgithub.com/Microsoft/hcsshim/internal/controller/device/scsi/save;saveb\x06proto3"
...
var file_github_com_Microsoft_hcsshim_internal_controller_device_scsi_save_payload_proto_goTypes = []any{
	(*Payload)(nil),     // 0: hcsshim.controller.scsi.save.v1.Payload
	(*DiskState)(nil),   // 1: hcsshim.controller.scsi.save.v1.DiskState
	(*DiskConfig)(nil),  // 2: hcsshim.controller.scsi.save.v1.DiskConfig
	(*MountState)(nil),  // 3: hcsshim.controller.scsi.save.v1.MountState
	(*MountConfig)(nil), // 4: hcsshim.controller.scsi.save.v1.MountConfig
	(*Reservation)(nil), // 5: hcsshim.controller.scsi.save.v1.Reservation
	nil,                 // 6: hcsshim.controller.scsi.save.v1.Payload.DisksEntry
	nil,                 // 7: hcsshim.controller.scsi.save.v1.Payload.ReservationsEntry
	nil,                 // 8: hcsshim.controller.scsi.save.v1.DiskState.MountsEntry
}
var file_github_com_Microsoft_hcsshim_internal_controller_device_scsi_save_payload_proto_depIdxs = []int32{
	6, // 0: hcsshim.controller.scsi.save.v1.Payload.disks:type_name -> hcsshim.controller.scsi.save.v1.Payload.DisksEntry
	7, // 1: hcsshim.controller.scsi.save.v1.Payload.reservations:type_name -> hcsshim.controller.scsi.save.v1.Payload.ReservationsEntry
	2, // 2: hcsshim.controller.scsi.save.v1.DiskState.config:type_name -> hcsshim.controller.scsi.save.v1.DiskConfig
	8, // 3: hcsshim.controller.scsi.save.v1.DiskState.mounts:type_name -> hcsshim.controller.scsi.save.v1.DiskState.MountsEntry
	4, // 4: hcsshim.controller.scsi.save.v1.MountState.config:type_name -> hcsshim.controller.scsi.save.v1.MountConfig
	1, // 5: hcsshim.controller.scsi.save.v1.Payload.DisksEntry.value:type_name -> hcsshim.controller.scsi.save.v1.DiskState
	5, // 6: hcsshim.controller.scsi.save.v1.Payload.ReservationsEntry.value:type_name -> hcsshim.controller.scsi.save.v1.Reservation
	3, // 7: hcsshim.controller.scsi.save.v1.DiskState.MountsEntry.value:type_name -> hcsshim.controller.scsi.save.v1.MountState
