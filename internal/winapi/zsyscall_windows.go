...
func deriveCapabilitySIDsFromName(capability string, groupSIDs ***windows.SID, groupSIDsCount *uint32, sids ***windows.SID, sidsCount *uint32) (err error) {
	var _p0 *byte
	_p0, err = syscall.BytePtrFromString(capability)
	if err != nil {
		return
	}
...
func _deriveCapabilitySIDsFromName(capability *byte, groupSIDs ***windows.SID, groupSIDsCount *uint32, sids ***windows.SID, sidsCount *uint32) (err error) {
