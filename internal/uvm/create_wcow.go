...
func prepareConfigDocCommon(ctx context.Context, uvm *UtilityVM, opts *OptionsWCOW) (*hcsschema.ComputeSystem, error) {
...
func prepareSecurityConfigDoc(ctx context.Context, uvm *UtilityVM, opts *OptionsWCOW) (*hcsschema.ComputeSystem, error) {
	...
	doc, err := prepareConfigDocCommon(ctx, uvm, opts)
	if err != nil {
		return nil, err
	}
