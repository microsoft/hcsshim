...
func (uvm *UtilityVM) AddSCSI(ctx context.Context, hostPath string, uvmPath string, readOnly bool) (_ int, _ int32, err error) {
	ctx, span := trace.StartSpan(ctx, "uvm::AddSCSI")
	defer span.End()
...
func (uvm *UtilityVM) AddSCSIPhysicalDisk(ctx context.Context, hostPath, uvmPath string, readOnly bool) (_ int, _ int32, err error) {
	ctx, span := trace.StartSpan(ctx, "uvm::AddSCSIPhysicalDisk")
	defer span.End()
	defer func() { oc.SetSpanStatus(span, err) }()
	span.AddAttributes(
		trace.StringAttribute(logfields.UVMID, uvm.id),
...
func (uvm *UtilityVM) AddSCSILayer(ctx context.Context, hostPath string) (_ int, _ int32, err error) {
	ctx, span := trace.StartSpan(ctx, "uvm::AddSCSILayer")
	defer span.End()
	defer func() { oc.SetSpanStatus(span, err) }()
	span.AddAttributes(
		trace.StringAttribute(logfields.UVMID, uvm.id),
...
func (uvm *UtilityVM) addSCSIActual(ctx context.Context, hostPath, uvmPath, attachmentType string, isLayer, readOnly bool) (_ int, _ int32, err error) {
	ctx, span := trace.StartSpan(ctx, "uvm::addSCSIActual")
	defer span.End()
	defer func() { oc.SetSpanStatus(span, err) }()
	span.AddAttributes(
		trace.StringAttribute(logfields.UVMID, uvm.id),
		trace.StringAttribute("host-path", hostPath),
		trace.StringAttribute("uvm-path", uvmPath),
		trace.StringAttribute("attachmentType", attachmentType),
		trace.BoolAttribute("isLayer", isLayer),
		trace.BoolAttribute("readOnly", readOnly))
...
func (uvm *UtilityVM) RemoveSCSI(ctx context.Context, hostPath string) (err error) {
	ctx, span := trace.StartSpan(ctx, "uvm::RemoveSCSI")
	defer span.End()
	defer func() { oc.SetSpanStatus(span, err) }()
	span.AddAttributes(
		trace.StringAttribute(logfields.UVMID, uvm.id),
...
func (uvm *UtilityVM) GetSCSIUvmPath(ctx context.Context, hostPath string) (_ string, err error) {
	ctx, span := trace.StartSpan(ctx, "uvm::GetSCSIUvmPath")
	defer span.End()
	defer func() { oc.SetSpanStatus(span, err) }()
	span.AddAttributes(
		trace.StringAttribute(logfields.UVMID, uvm.id),
