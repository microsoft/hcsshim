...
func IsNotExist(err error) bool {
	return hcserror.Is(err, ErrComputeSystemDoesNotExist, ErrElementNotFound)
}
...
func IsAlreadyStopped(err error) bool {
	return hcserror.Is(err, ErrVmcomputeAlreadyStopped, ErrProcessAlreadyStopped, ErrElementNotFound)
}
...
func IsNotSupported(err error) bool {
	...
	return hcserror.Is(err, ErrVmcomputeInvalidJSON, ErrInvalidData, ErrNotSupported, ErrVmcomputeUnknownMessage)
}
